...
function blossom_floral_dynamic_css(){
	...
	$topbar_color      = get_theme_mod( 'topbar_color', '#e5f9f9' );
    $topbar_font_color = get_theme_mod( 'topbar_font_color', '#001A1A' );
    ...
    .sticky-t-bar .sticky-bar-content  {
        background: <?php echo blossom_floral_sanitize_hex_color( $topbar_color ); ?>;
        color: <?php echo blossom_floral_sanitize_hex_color( $topbar_font_color ); ?>;
    }
